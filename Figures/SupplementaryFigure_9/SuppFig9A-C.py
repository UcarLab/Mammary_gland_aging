...
# %%
## Data load
age_group = "Young" # It should be set as Old or Young
...
clu_adata3 = Check_mark(adata3, "sqrt_norm", lib_id3, "None")
clu_adata4 = Check_mark(adata4, "sqrt_norm", lib_id4, "None")
# %%
## Check the marker genes on merged set
clu_old = Check_mark(old, "sqrt_norm", "Merged_old", "Supp_Fig9C")
# %%
sc.pl.spatial(clu_adata3,
              ...
              size=1.7,
              palette=same_col_code,
              save="Supp_Fig9A_ST_{}".format(lib_id3))
# %%
sc.pl.spatial(clu_adata4,
              ...
              size=1.7,
              palette=same_col_code,
              save="Supp_Fig9A_ST_{}".format(lib_id4))
# %%
