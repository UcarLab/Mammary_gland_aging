...
cd_genes <- list('Monocytes'=c("Cd14","S100a8","S100a9"),
                 ...
                 'M1 like' = c("Mmp12", "Mmp13", "Spic","Cd80", "Cd86","Cd38"),
                 'M2 like' = c("Mrc1", "Cd209f", "Cd163","Cd83","Egr2","Cd9","Cd74","Bcl2","Arg1"),
                 'mregDC' = c("Ccr7", "Fscn1","Socs2","Relb", "Il4i1", "Cd40", "Cd274"),
                 'Dendritic Cells' = c("Cd209a", "Traf1", "Napsa", "Flt3", "Fcgr2b", "Itgam"),
                 'cDC1' = c("Clec9a","Xcr1","Naaa","Cadm1"),
