# 01162023
# Attempting to generate a DGE list from  Luminal B Tumors in TCGA vs all normal samples
...
# Subset Normal and Luminal B
brca_dds_colData_final <- subset(brca_dds_colData_final, brca_dds_colData_final$New_Column == 'LumB' | brca_dds_colData_final$ShortLetterCode == "NT")
...
write.csv(BRCA_norm_counts.log, "C:/Users/angarb/OneDrive - The Jackson Laboratory/Documents/Anczukow Lab/TCGA_MatchDGE/AllTumors_07262022/Outputs/Log_Normcounts_TCGA_LumBvsNormal.csv") 
